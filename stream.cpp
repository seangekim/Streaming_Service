...
int main(int argc, char* argv[])
{
    ...
    const char* no_user_fexcept_msg = "No user logged in";
    ...
    catch(ParserError){ // returns parsing errors
        cout << "what" << endl;
        return 1;
    }
    ...
    while(option != 0) {
        ...
        // catch blocks to identify and throw errors back at user         
        catch(UserNotLoggedInError){
            cout << no_user_fexcept_msg << endl;
        }
